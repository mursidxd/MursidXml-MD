...
conn.sendStimg(m.chat, pickRandom(stikerhuuu), m, { packname: "sᴛɪᴄᴋᴇʀ ʙʏ", author: "мυʀѕι∂ вσт-χмℓ" })
}

handler.customPrefix = /^(huu|hai|huff|kontol|memek|anj|asu|bot|makasih)$/i
