...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await this.getName(owner[0] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'mursids@gmail.com', true],
         [owner[1], await this.getName(owner[1] + '@s.whatsapp.net'), 'ᴘᴀʀᴛɴᴇʀ ɴᴀᴅɪᴀ ʙᴏᴛ', 'nadiafaradiba@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					//sourceUrl: 'https://wa.me/6288233832771',
				}
			}
		}
